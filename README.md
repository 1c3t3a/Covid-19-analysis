...
![sample covid-19 plot](plot.png)
![sample covid-19 plot](plot2.png)

You can also generate heatmaps using *pygal* such as this:

![sample covid-19 heatmap](output_29_12.svg)
...
![sample covid-19 MacOS app](version41.png)

![sample covid-19 Windows app](screenshot.png)
